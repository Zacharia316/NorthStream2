...
export default function NorthStreamHome() {
  ...
  return (
    <div style={{
      ...
      {/* ===== SINGLE VIDEO ELEMENT — repositions via CSS, never remounts ===== */}
      <video
        ref={videoRef}
        playsInline
        ...
        style={
          playerState === "full" ? {
            ...
            aspectRatio: "16/9", zIndex: 301, objectFit: "contain", background: "#000",
          } : playerState === "mini" ? {
            position: "fixed", top: "9px", left: "14px",
            width: "80px", height: "46px", zIndex: 201,
            objectFit: "cover", borderRadius: "6px", background: "#000",
          } : {
      ...
      {playerState === "mini" && activeChannel && (
        ...
        >
          {/* Video is the always-mounted element above, positioned via CSS */}
          <div style={{
      ...
      {playerState === "full" && activeChannel && (
        <div className="ns-fade" style={{
          ...
          >
            {/* Video element is the always-mounted one above, positioned via CSS */}
